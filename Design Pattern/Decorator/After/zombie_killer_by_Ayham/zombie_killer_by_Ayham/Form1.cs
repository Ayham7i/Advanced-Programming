...
namespace zombie_killer_by_Ayham
{
    public partial class Form1 : Form
    {
        ...
        {
            IBullet basicBullet = new BasicBullet(direction, player.Left + (player.Width / 2), player.Top + (player.Height / 2));

            // Apply decorators if needed
            IBullet decoratedBullet = new SpeedBulletDecorator(basicBullet, 5); // example: add speed

            decoratedBullet.MakeBullet(this);
        }
